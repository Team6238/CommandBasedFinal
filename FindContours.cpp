...
void FindContours::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {48.06820152151943, 101.49244855468928};
	double hsvThresholdSaturation[] = {125.28776723275082, 254.924907759188};
	double hsvThresholdValue[] = {122.30215535747061, 255.0};
 ...
 */
cv::Mat* FindContours::GetCvResizeOutput(){
 ...
 */
cv::Mat* FindContours::GetHsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* FindContours::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* FindContours::GetFilterContoursOutput(){
	 ...
	 */
	void FindContours::cvResize(cv::Mat &src, cv::Size &dSize, double fx, double fy, int interpolation, cv::Mat &dst) {
	 ...
	 */
	void FindContours::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void FindContours::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void FindContours::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
